---
title: "3 UNIT"      # Название урока, будет отображаться в списке
order: 5                      # Порядок отображения (очень важно для курса)
duration: 20 min              # Длительность (можно вывести рядом)
